...
export default function CreateTranslationHero() {
  ...
  const handleSubmit = async () => {
    try {
      ...
      const res = await fetch('/api/admin/translation/hero', {
        method: 'POST',
  ...
  return (
    <div className="p-4 max-w-xl mx-auto">
      <h1 className="text-2xl font-bold mb-4">Create Translation Hero</h1>
