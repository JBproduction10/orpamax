...
const TranslationServicesAdminList = () => {
  const { data: services, mutate } = useSWR('/api/admin/translation/services', fetcher);

  const handleDelete = async (id: string) => {
    if (!confirm('Are you sure?')) return;
    await fetch(`/api/admin/translation/services/${id}`, { method: 'DELETE' });
    mutate();
  };
  ...
  return (
    <div className="p-4 max-w-5xl mx-auto">
      <div className="flex justify-between items-center mb-4">
        ...
        <Link href="/admin/dashboard/translation-services/services/create">
        ...
        {services?.map((service: any) => (
          <div key={service._id} className="border rounded p-4 space-y-2 shadow">
            ...
            <div className="flex gap-2">
              <Link href={`/admin/dashboard/translation-services/services/edit/${service._id}`}>
                <Button>Edit</Button>
              </Link>
...
export default TranslationServicesAdminList;
