...
const EditTranslationService = () => {
  ...
  useEffect(() => {
    fetch(`/api/admin/translation/services/${id}`)
      .then(res => res.json())
      .then(setData);
  }, [id]);
  ...
  return (
    <div className="max-w-2xl mx-auto px-6 py-10">
      <div className="bg-white dark:bg-gray-900 shadow-lg rounded-2xl p-8 space-y-6 border border-gray-200 dark:border-gray-700">
        <h2 className="text-2xl font-semibold text-gray-800 dark:text-gray-100">Edit Translation Service</h2>
...
export default EditTranslationService;
