...
export default function EditHomeHero() {
  ...
  const handleSubmit = async () => {
    try {
      ...
      const updateRes = await fetch(`/api/admin/home/hero/${id}`, {
        method: 'PUT',
      ...
      router.push('/admin/dashboard/home/hero');
    } catch (err: any) {
  ...
  return (
    <div className="p-4 max-w-xl mx-auto">
      <h1 className="text-2xl font-bold mb-4">Edit Home Hero</h1>
